...
- **Python**: Passionné par l'automatisation, la création de scripts, l'utilisation des API GraphQL, et le développement backend.
- **JavaScript**: Expérience en développement web, création de sites interactifs (React).
- **Lua & C++**: Très investi dans le développement de jeux vidéo et la création de mods/scripts, particulièrement pour Unreal Engine.
- **GitHub Actions**: Fortes compétences en CI/CD, automatisation de workflows, et gestion de dépôts GitHub (comme ce profil dynamique !).
...
### 📂 Mes Dépôts Récents (Mise à jour dynamique !)

<!-- DYNAMIC_REPOS_START -->

#### 📦 [mock-repo-1](https://github.com/LaTortu3/mock-repo-1) ⭐ 42 | 🛠️ Python
Derniers commits :
- `2024-05-01` : Initial commit
- `2024-05-02` : Update README
- `2024-05-03` : Fix typo

#### 📦 [mock-repo-2](https://github.com/LaTortu3/mock-repo-2) ⭐ 10 | 🛠️ JavaScript
Derniers commits :
- `2024-05-04` : Add new feature
